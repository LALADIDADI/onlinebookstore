...
<div class="cBody">
        ...
        <form class="layui-form" action="customer_select.php" method="post">
            <div class="layui-form-item">
                <div class="layui-input-inline">
                    <input type="text" name="cname"  lay-verify="required" placeholder="客户账号/客户昵称" autocomplete="off" class="layui-input">
                </div>
    ...
    <table class="layui-table">
        ...
        if($conn->connect_error){
            ...
            $sql = "select cname,cnumber,cpassword from customer";
            //调用数据库的方法改变
