...
<div class="cBody">
    <div class="console">
        <form class="layui-form" action="../admin/order_book_select.php" method="post">
    ...
    <table class="layui-table">
        ...
        if($conn->connect_error){
            ...
            while($row = mysqli_fetch_row($result)){
                ...
                echo '<td>'.$row[2].'</td>';
                echo '<td>'.$row[3].'</td>';
                echo "<td><a class='layui-btn layui-btn-xs' href='get_orderbook_update.php?bnumber=".$row[0]."&bname=".$row[1]."&price=".$row[2]."&amount=".$row[3]."'>修改信息</a></td></tr>";
            }
            $conn->close();
        }
        ?>
